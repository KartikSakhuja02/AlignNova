      ...
      <aside className="bg-white h-screen w-64 fixed left-0 top-0 border-r border-outline-variant shadow-sm flex flex-col py-6 z-50">
        ...
        <nav className="flex-1 px-4 space-y-2">
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 text-left ${activeTab === 'dashboard' ? 'text-primary font-bold bg-primary/5 border-r-4 border-primary' : 'text-on-surface-variant hover:text-primary hover:bg-slate-50'}`}
          >
            <span className="material-symbols-outlined">dashboard</span>
            <span className="text-body-md">Dashboard</span>
          </button>
          <a className="flex items-center gap-3 px-4 py-3 rounded-xl text-on-surface-variant hover:text-primary hover:bg-slate-50 transition-colors cursor-not-allowed opacity-50" href="#" onClick={(e) => e.preventDefault()}>
          ...
          <button 
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 text-left ${activeTab === 'settings' ? 'text-primary font-bold bg-primary/5 border-r-4 border-primary' : 'text-on-surface-variant hover:text-primary hover:bg-slate-50'}`}
          >
          ...
          <button 
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-error hover:bg-error-container/10 transition-colors text-left mt-auto"
          >
      ...
      <main className="ml-64 flex-1 min-h-screen flex flex-col">
        ...
        <div className="pt-24 pb-12 px-8 max-w-[1400px] w-full mx-auto space-y-8 flex-1">
          {activeTab === 'dashboard' ? (
                  ...
                  <div className="bg-white rounded-2xl border border-outline-variant shadow-sm overflow-hidden">
                    <div className="p-6 border-b border-outline-variant flex justify-between items-center bg-white/50">
                      ...
                      <div className="flex gap-2">
                        <button className="p-2 text-on-surface-variant hover:bg-slate-50 rounded-lg transition-colors" onClick={(e) => e.preventDefault()}>
                              ...
                              return (
                                <tr key={student.id} className="hover:bg-slate-50/50 transition-colors group">
                                  ...
                                  <td className="px-6 py-4 text-right">
                                    <button className="text-primary hover:underline font-bold text-caption" onClick={(e) => e.preventDefault()}>Review Portfolio</button>
                                  </td>
                                </tr>
                              );
                            })
                    ...
                    <div className="p-4 bg-slate-50 text-center">
                      <button className="text-primary font-bold text-caption hover:underline flex items-center justify-center gap-1.5 mx-auto" onClick={(e) => e.preventDefault()}>
                ...
                <div className="col-span-12 lg:col-span-4 space-y-6">
                  ...
                  <div className="bg-white rounded-2xl border border-outline-variant shadow-sm p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex gap-4 p-3 rounded-xl hover:bg-slate-50 transition-colors group cursor-pointer border border-transparent hover:border-outline-variant/40" onClick={(e) => e.preventDefault()}>
            ...
            <div className="max-w-[700px] bg-white p-6 border border-slate-100 rounded-2xl shadow-sm animate-fadeIn">
              <h3 className="font-bold text-body-lg text-on-surface mb-2">Preferences</h3>
              <p className="text-on-surface-variant text-caption mb-6">
                Update configuration preferences for your partner portal experience.
              </p>
